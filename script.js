...
function getSavedColumns() {
  ...
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['Proiect PSI'];
    progressListArray = ['Lucrare licenta', 'Ascult muzica'];
    completeListArray = ['Mini vacanta', 'Proiect DSW'];
    onHoldListArray = ['Camping'];
  }
}
...
// Store in memory after drag and drop
...
function allowDrop(e) {
  // By default elements cant be dropped on another elements
  e.preventDefault();
}
